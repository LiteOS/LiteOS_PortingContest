...
目前在github上已开源的Huawei LiteOS内核源码已适配好STM32F412、STM32F429、STM32L476、GD32F450、GD32F190芯片，本手册将以GD32F150R8T6芯片为例，介绍基于Cortex M3核芯片的移植过程
...
<table>
	...
	<tr>
	<td>GD32F150R-EVAL单板</td>
	<td>GD32开发板(芯片型号GD32F150R8T6)</td>
	</tr>
	<tr>
	<td>PC机</td>
	<td>用于编译、加载并调试镜像</td>
...
通过Keil 5.23直接生成一个工程文件，在工程生成导向里添加所有的库文件，并选择对应的板载资源的驱动文件。
![](./meta/keil/gd32f150/add_file_0.jpg)

拷贝LiteOS内核代码以及用于测试的example文件夹，拷贝到工程目录下。
![](./meta/keil/gd32f150/add_file_1.jpg)

拷贝LiteOS示例工程文件夹platform\GD32F190R-EVAL下的4个驱动文件到工程目录下新建的platform/gd32f150r文件夹中。

![](./meta/keil/gd32f150/add_file_2.jpg)

拷贝完成后的工程文件夹内容如下图

![](./meta/keil/gd32f150/add_file_3.jpg)

GD示例工程代码目录结构

![](./meta/keil/gd32f150/add_file_4.jpg)

GD示例工程启动文件startup_gd32f1x0.s,由于在工程生成向导里启动文件已经添加进来了，无需重复添加到startup文件夹下。

![](./meta/keil/gd32f150/add_file_5.jpg)

**添加头文件搜索路径**

![](./meta/keil/gd32f150/folder_setup.jpg)

**添加编译宏选项**

![](./meta/keil/gd32f150/add_macro.jpg)
