...
获取Huawei LiteOS源代码之后，我们可以将LiteOs源码移植到自己开发板中(如：NRF52840-PDK)。

## 6如何移植到NRF52840-PDK硬件平台上
本章节描述的内容以NRF52840开发包中的uart示例工程为基础，创建NRF52840-PDK-KEIL工程，演示串口输出、按键检测及LED点亮功能。
